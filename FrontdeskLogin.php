  ...
  if (isset($_POST["submit"])) {
    ...
    if (mysqli_num_rows($result) > 0) {
      ...
      if ($row['role'] !== 'Frontdesk') {
        $_SESSION['login_error'] = 'Access restricted to Frontdesk users only.';
...
<html lang="en">
  ...
  <body>
    <div class="w-full max-w-4xl mx-4 flex flex-col md:flex-row rounded-xl overflow-hidden shadow-lg mt-10">
      <!-- Left -->
      <div class="w-full md:w-2/5 bg-blue-600 flex items-center justify-center p-6">
        <div class="text-center">
          <div class="logo-pulse mb-4">
            <img src="nobglogo.png" width="500" height="200" class="text-white mx-auto" />
          </div>

          <h1 class="text-3xl font-bold text-white mb-2">Frontdesk</h1>
      ...
      <div class="login-container w-full md:w-3/5 p-6">
        ...
        <div id="successMessage" class="hidden mt-4 p-3 rounded-lg bg-green-100 text-green-700 text-center text-sm">
